'use client';
import { Box, Button, CardContent, Chip, Grid, Skeleton, Table, TableBody, TableCell, TableHead, TablePagination, TableRow, TextField, Typography } from '@mui/material';
...
const LabPage = (params:any) => {
    ...
    const [ date, setDate ] = useState<Dayjs | null>(dayjs(params['params']['date'])) //2021-03-15
  ...
  return (
    ...
    <PageContainer title="LAB 2.0 :  Lab Page" description="this is Sample page">
                                    ...
                                    <TableRow key={row.visitno}>
                                        ...
                                        <TableCell align="right">
                                            <Link href={`visit-no/${row['visitno']}`}>
                                                <Button color="primary" variant='outlined' startIcon={<IconUser width={18} />}>
                                                    รายละเอียด
                                                </Button>
                                            </Link>
                                            {row['visitno']}
